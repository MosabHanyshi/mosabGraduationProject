...
class _AddCardsPageState extends State<AddCardsPage> {
  CreditCardColor active = CreditCardColor.RED;
  ...
  String getCardIcon() {
    if (cardNumber.text.isEmpty)return 'assets/images/unknown.png';
    switch (cardNumber.text.substring(0, 1)) {
      case '4':
        {
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: CreditCardColor.values
                            .map((c) => InkWell(
                                  onTap: () {
                                    setState(() {
                                      active = c ?? CreditCardColor.RED;
                                    });
                                  },
                      ...
                      child: InkWell(
                        onTap: () => {
                          newCard = CreditCard(
                              ...
                              color: active,
                              cvv: int.parse(cvc.text),
                              number: int.parse(cardNumber.text),
                              year: int.parse(year.text),
                              month: month.text,
                              isDefault:false),
                          BlocProvider.of<CardsCubit>(context).addNewCards(newCard),
