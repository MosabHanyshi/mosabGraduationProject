...
class ChatRoom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: AppColors.yellow95,
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              filled: true,
                              hintStyle: TextStyle(color: AppColors.blue76),
                              fillColor: AppColors.blue76.withOpacity(0.2)),
                        ),
                      ),
                      IconButton(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: map['sendby'] == _auth.currentUser!.displayName
                      ? AppColors.blue76.withOpacity(0.1)
                      : AppColors.yellow95.withOpacity(0.1),
                  boxShadow: [
                    BoxShadow(
                      color: AppColors.yellow95.withOpacity(0.1),
                      blurRadius: 9.0,
                      spreadRadius: 1.0,
